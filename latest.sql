...
CREATE TABLE public.campaign_lead_lists (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  campaign_id uuid NOT NULL,
  ...
  CONSTRAINT campaign_lead_lists_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.campaigns(id),
  CONSTRAINT campaign_lead_lists_lead_list_id_fkey FOREIGN KEY (lead_list_id) REFERENCES public.lead_lists(id),
  CONSTRAINT campaign_lead_lists_assigned_by_fkey FOREIGN KEY (assigned_by) REFERENCES auth.users(id)
);
CREATE TABLE public.campaign_leads (
  ...
  CONSTRAINT campaign_leads_lead_list_id_fkey FOREIGN KEY (lead_list_id) REFERENCES public.lead_lists(id)
);
...
CREATE TABLE public.campaigns (
  ...
  exclude_dnc boolean NOT NULL DEFAULT true,
  audience_contact_count integer NOT NULL DEFAULT 0,
...
CREATE TABLE public.lead_list_members (
  ...
  CONSTRAINT lead_list_members_added_by_fkey FOREIGN KEY (added_by) REFERENCES auth.users(id)
);
CREATE TABLE public.lead_lists (
  ...
  list_type character varying DEFAULT 'static'::character varying,
  ...
  CONSTRAINT lead_lists_business_id_fkey FOREIGN KEY (business_id) REFERENCES public.businesses(id),
  CONSTRAINT lead_lists_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id),
  CONSTRAINT lead_lists_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES auth.users(id)
);
