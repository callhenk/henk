...
This document provides a comprehensive overview of all available scripts in the Henk AI project, organized by category and purpose.
...
*This script reference helps you navigate the available commands. For detailed usage, see the individual documentation files.* 